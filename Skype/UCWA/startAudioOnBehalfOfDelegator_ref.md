...
Represents an operation to start Audio call on behalf of the delegator. This token indicates 
the user has ability to start audio call on behalf of the delegator.
...
Starts a AudioInvitation on behalf of delegator and creates a new conversation with a contact.
...
```
Post https://fe1.contoso.com:443/ucwa/v1/applications/192/communication/startAudioOnBehalfOfDelegator HTTP/1.1
