...
Represents an operation to add audio to an existing conversation.
...
Adds Audio to a Conversation and starts a AudioInvitation.
...
```
Post https://fe1.contoso.com:443/ucwa/v1/applications/192/communication/conversations/137/audioVideo/addAudio HTTP/1.1
