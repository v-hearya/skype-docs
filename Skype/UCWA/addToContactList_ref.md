...
|**Name**|**Description**|**Required?**|
|:-----|:-----|:-----|
|displayName|Distribution group display nameThe maximum length is 256 characters. String|Yes|
|smtpAddress|Distribution group SMTP addressString|Yes|
...
```
Post https://fe1.contoso.com:443/ucwa/v1/applications/192/groups/addToContactList HTTP/1.1
