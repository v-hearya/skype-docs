...
Represents an operation to add audio/video to an existing conversation.
...
Adds AudioVideo to a Conversation and starts a [audioVideoInvitation](audioVideoInvitation_ref.md).
...
```
Post https://fe1.contoso.com:443/ucwa/v1/applications/192/communication/conversations/137/audioVideo/addAudioVideo HTTP/1.1
