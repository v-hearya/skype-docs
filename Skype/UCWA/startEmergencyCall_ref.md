...
Starts an E911 (Emergency) Call provided enhanced emergency services are enabled for the registered user
...
|address|AddressString|No|
|building|Building/Room NoString|No|
|city|CityString|No|
|country|Country/RegionString|No|
|state|State/ProvinceString|No|
|zip|Zip/PostalCodeString|No|
...
```
Post https://fe1.contoso.com:443/ucwa/v1/applications/192/communication/startEmergencyCall HTTP/1.1
...
&lt;input xmlns=&quot;http://schemas.microsoft.com/rtc/2012/03/ucwa&quot;&gt;
  ...
  &lt;property name=&quot;state&quot;&gt;samplevalue&lt;/property&gt;
