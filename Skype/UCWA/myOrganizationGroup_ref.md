...
Represents a group of user's organization contacts
...
A organization group is a logical container for user's organization contacts including manager, peers and direct reports
...
Returns a representation of a group of contacts for the users organization
...
```
Get https://fe1.contoso.com:443/ucwa/v1/applications/192/groups/myOrganizationGroup HTTP/1.1
...
<resource rel="myOrganizationGroup" href="/ucwa/v1/applications/192/groups/myOrganizationGroup" xmlns="http://schemas.microsoft.com/rtc/2012/03/ucwa">
  ...
  <property name="rel">myOrganizationGroup</property>
