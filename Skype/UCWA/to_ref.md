...
```
Get https://fe1.contoso.com:443/ucwa/v1/applications/192/people/107 HTTP/1.1
Authorization: Bearer cwt=PHNhbWw6QXNzZXJ0aW9uIHhtbG5...uZm8
Host: fe1.contoso.com
Accept: application/json
if-none-match: aecc5c96-e196-4c5a-81e6-f5cd54c6ed10
```
...
```
HTTP/1.1 200 OK
Etag: 8b43e746-8e5f-4163-8828-28dfcbfa6717
...
if-none-match: 2566ca03-4d0e-478d-b0ba-b54996939a48
```
...
```
HTTP/1.1 200 OK
Etag: f88be84d-f4fd-4efa-b11c-f04384ce5a74
