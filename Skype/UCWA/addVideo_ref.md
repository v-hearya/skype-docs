...
Represents an operation to add video to an existing conversation.
...
Adds Video to a Conversation and starts a VideoInvitation.
...
```
Post https://fe1.contoso.com:443/ucwa/v1/applications/192/communication/addVideo HTTP/1.1
